...
import { IconChecklist } from '@tabler/icons-react'; // Import the icon
...
const IncidenceColumn: React.FC<Props> = ({ title, toolbar, incidencias, columnClass, onUpdateStatus, droppableId, seeMorePath }) => {
  return (
